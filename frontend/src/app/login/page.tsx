        ...
        <div className="w-full max-w-md">
          <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-white/20">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-semibold text-patina-800 mb-2">Welcome back</h2>
              <p className="text-patina-600">Sign in to your account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label className="block text-sm font-medium text-patina-700">Password</label>
                  <a href="/forgot-password" className="text-sm text-patina-500 hover:text-patina-600 transition-colors">
                    Forgot password?
                  </a>
                </div>
                <input
            ...
            <div className="text-center mt-8">
              <p className="text-patina-600">
                ...
                <a href="/register" className="text-patina-500 hover:text-patina-600 font-medium transition-colors duration-200">
                  Create account
                </a>
              </p>
            </div>
